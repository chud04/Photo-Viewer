...
public class ImageViewerActivity extends View {
 ...
 public ImageViewerActivity(Context context, Bitmap src) {
  super(context);
  phonePixH = MainActivity.phonePixH;
  phonePixW = MainActivity.phonePixW;
  toDisplay = src;
