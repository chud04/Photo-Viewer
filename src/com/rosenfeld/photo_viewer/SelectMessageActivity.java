...
public class SelectMessageActivity extends MainActivity {
 ...
 CheckBox italicsCheckBox,boldCheckBox;
  ...
  /** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textChoice = false;
        picChoice = false;
        picThumb = BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher);
     ...
     switch(requestCode){
      case SELECT_GALLERY_PIC_REQUEST:
       ...
       if(resultCode == Activity.RESULT_CANCELED){
        ...
        imageThumb.setBackground(picThumbDrawable);
       }
       break;
      default:
       break;
