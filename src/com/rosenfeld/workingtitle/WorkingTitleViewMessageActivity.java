...
public class WorkingTitleViewMessageActivity extends WorkingTitleActivity implements 
SensorEventListener{
 
 //Declare all the Views, etc. that can be instantiated with the ids from the .xml file
 SensorManager sm;
 Sensor mags,accels;
 WorkingTitleImageViewer pictureView;
 ...
 int picWidth,picHeight;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bitmapsrc = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(getResources(),
          R.drawable.icon),picWidth,picHeight,false);
        pictureView = new WorkingTitleImageViewer(this, bitmapsrc);
